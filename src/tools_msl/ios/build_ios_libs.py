...
def main():
    ...
    # Combine the slices.
    dylib_path = os.path.join(SDK_FRAMEWORK_NAME + '.framework', SDK_FRAMEWORK_NAME)
    ...
    distutils.dir_util.copy_tree(
        ...
        os.path.join(args.output_dir, SDK_FRAMEWORK_NAME + '.framework'))
    ...
    if os.path.isdir(lib_dsym_dir_path):
        ...
        infoplist_path = os.path.join(args.output_dir, SDK_FRAMEWORK_NAME + '.framework',
                                      'Info.plist')
        cmd = [
